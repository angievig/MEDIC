...
public class Felferning2 {
	...
	public void initConstraints(){
		...
		c9= new Constraint("C9","Gui #==> Games"); // gui requiere games
		...
		c11= new Constraint("C11", "TextEditor+ Gnuchess #=< 1");
		c11.addVariable(textEditor);
		c11.addVariable(gnuchess);
		
		c12= new Constraint("C12", "Bash + Glchess #=< 1");
		c12.addVariable(bash);
		c12.addVariable(glchess);
