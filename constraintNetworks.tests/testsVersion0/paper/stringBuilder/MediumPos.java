...
public class MediumPos {
	static String path= "C:/Users/Angela Villota/Documents/Tests/Grupo/Execution/Problema5/";
	private static CSP csp;
	static private XCSPPrologParser Xparser;
	static String filename= "Renault-medium-pos.xml";
...
//		X7_80#=1,
		...
		cn2= new Constraint("CN2","X5_5#=0");
		csp.addConstaint(cn2);
		csp.addVarToConstraint(cn2, "X5_5");

		cn3= new Constraint("CN3","X7_0 #\\=1");
		csp.addConstaint(cn3);
		csp.addVarToConstraint(cn3, "X7_0");
...
//		csp.addVarToConstraint(cn6, "X7_80");
	...
	static void  purgeDirectory(File dir) {
		System.out.println("limpiando la carpeta");
