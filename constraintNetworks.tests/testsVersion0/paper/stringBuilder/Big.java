...
public class Big {
	static String path= "C:/Users/Angela Villota/Documents/Tests/Grupo/Execution/Problema8/";
	private static CSP csp;
	static private XCSPPrologParser Xparser;
	static String filename= "Renault-big.xml";
...
//			
	...
	static void nuevasRestriccionesHard(){
		//nuevas restricciones
		Constraint cn1, cn2, cn3, cn4, cn5, cn6; 

		cn1= new Constraint("CN1","X4_49#=0");
		csp.addConstaint(cn1);
		csp.addVarToConstraint(cn1, "X4_49");
		
		cn2= new Constraint("CN2","X5#=5");
		csp.addConstaint(cn2);
		csp.addVarToConstraint(cn2, "X5");
