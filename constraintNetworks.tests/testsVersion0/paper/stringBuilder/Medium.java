...
public class Medium {
	static String path= "C:/Users/Angela Villota/Documents/Tests/Grupo/Execution/Problema6/";
	private static CSP csp;
	static private XCSPPrologParser Xparser;
	static String filename= "Renault-medium.xml";
...
//		X7_75#=1,
//		X7_80#=1,
		cn1= new Constraint("CN1","X3_3#=0");
		csp.addConstaint(cn1);
		csp.addVarToConstraint(cn1, "X3_3");
		
		cn2= new Constraint("CN2","X3_2#=2");
		csp.addConstaint(cn2);
		csp.addVarToConstraint(cn2, "X3_2");
